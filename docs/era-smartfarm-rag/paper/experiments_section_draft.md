# 실험 섹션 초안 (Experiments Section Draft)

> **Note**: 이 문서는 논문의 실험 섹션 초안입니다. 실제 실험 결과가 생성되면 수치를 업데이트해야 합니다.
> 
...
### 4.4 Domain-Specific Analysis (RQ3)

**연구 질문 3**: 도메인 특화 기능들이 실제로 농업 도메인 질의에 효과적인가?

#### 4.4.1 Category-wise Performance
